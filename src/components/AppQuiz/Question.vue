<template>
    <v-card >
        <v-toolbar card color="white" >
            <v-toolbar-title class="" >{{question}}</v-toolbar-title>
        </v-toolbar>

        <v-card-text >
            <v-divider class="my-2"></v-divider>
            <v-btn depressed large color="primary" @click="onAnswer(btnData[0].correct)">{{btnData[0].answer }}</v-btn>
            <v-btn depressed large color="primary" @click="onAnswer(btnData[1].correct)">{{
                btnData[1].answer }}</v-btn>
            <v-btn depressed large color="primary" @click="onAnswer(btnData[2].correct)">{{
                btnData[2].answer }}</v-btn>
            <v-btn depressed large color="primary" @click="onAnswer(btnData[3].correct)">{{
                btnData[3].answer }}</v-btn>
        </v-card-text>
    </v-card>
</template>
<style>
