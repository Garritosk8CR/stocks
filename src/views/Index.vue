            ...
            <div class="md-layout">
                <div class="md-layout-item">
                    <div class="image-wrapper">
                        ...
                        <div class="brand">
                            <h1>Emilio's Vue practice</h1>
                            <h3>Good looking app for my crappy practice apps.</h3>
                        </div>
                    </div>
                    ...
                    <div class="md-layout">
                        <router-link :to="{name: 'landing'}" >
                            <div class="md-layout-item">
                                ...
                                <md-button class="md-simple md-success md-lg">View Landing Page</md-button>
                            </div>
                        </router-link>
                        ...
                        <router-link :to="{name: 'profile'}">
                            <div class="md-layout-item">
                                ...
                                <md-button  class="md-simple md-success md-lg">View Profile Page</md-button>
                            </div>
                        </router-link>
